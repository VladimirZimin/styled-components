...
import { StyledButtonVariant, StyledButton } from '../elements/StyledButton';
...
const StyledMoreButton = styled(StyledButton).attrs({
...
const StyledLabel = styled(Typography).attrs({
  ...
  background-color: ${({ theme }) =>
    theme.current === Theme.ADULT ? Color.GRAY_40 : Color.WHITE};
`;
...
const StyledWrapper = styled(StyledBaseCard)`
    ...
    <StyledWrapper className={className} to="#" unavailable={unavailable}>
      <StyledProductCard>
        ...
        <StyledContent>
          ...
          <StyledButtons>
            <StyledButton disabled={unavailable}>Купить</StyledButton>
            <StyledMoreButton disabled={unavailable}>
              Подробнее
            </StyledMoreButton>
          </StyledButtons>
        </StyledContent>
        ...
        <StyledIconButtons>
          <StyledIconButton
            aria-label="Добавить товар в сравнения"
